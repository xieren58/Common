...
public class IconTextSpan extends ReplacementSpan {
    ...
    public IconTextSpan(Context context, int color, String text) {
        if (TextUtils.isEmpty(text)) {
            return;
        }
        //初始化默认数值
        initDefaultValue(context, color, text);
        //计算背景的宽度
     ...
     * @param context
     */
    private void initDefaultValue(Context context, int color, String text) {
