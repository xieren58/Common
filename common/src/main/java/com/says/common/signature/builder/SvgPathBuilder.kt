...
class SvgPathBuilder constructor(private val mStartPoint: SvgPoint, private val mStrokeWidth: Int) {
	...
	fun append(controlPoint1: SvgPoint, controlPoint2: SvgPoint, endPoint: SvgPoint): SvgPathBuilder {
		mStringBuilder.append(makeRelativeCubicBezierCurve(controlPoint1, controlPoint2, endPoint))
		mLastPoint = endPoint
		return this
	}
	
	private fun makeRelativeCubicBezierCurve(controlPoint1: SvgPoint, controlPoint2: SvgPoint, endPoint: SvgPoint): String {
