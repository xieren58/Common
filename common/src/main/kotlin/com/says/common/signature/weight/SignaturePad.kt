 ...
 *  Date: 2021/4/2
 */
class SignaturePad @JvmOverloads constructor(context: Context, attr: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attr, defStyleAttr) {
    companion object {
    ...
    private fun initAttr(attr: AttributeSet?) {
        ...
        mMinWidth = styled.getDimensionPixelSize(R.styleable.Signature_Common_penMinWidth, convertDpToPx(DEFAULT_ATTR_PEN_MIN_WIDTH_PX.toFloat()))
        mMaxWidth = styled.getDimensionPixelSize(R.styleable.Signature_Common_penMaxWidth, convertDpToPx(DEFAULT_ATTR_PEN_MAX_WIDTH_PX.toFloat()))
        mPaint.color = styled.getColor(R.styleable.Signature_Common_penColor, DEFAULT_ATTR_PEN_COLOR)
        mVelocityFilterWeight = styled.getFloat(R.styleable.Signature_Common_velocityFilterWeight, DEFAULT_ATTR_VELOCITY_FILTER_WEIGHT)
        mClearOnDoubleClick = styled.getBoolean(R.styleable.Signature_Common_clearOnDoubleClick, DEFAULT_ATTR_CLEAR_ON_DOUBLE_CLICK)
        textPaint.color = styled.getColor(R.styleable.Signature_Common_textAddSize, DEFAULT_ATTR_PEN_COLOR)
        textPaint.textSize = styled.getDimensionPixelSize(R.styleable.Signature_Common_textAddSize, UICommon.sp2px(context, DEFAULT_TEXT_TIPS_SIZE)).toFloat()
